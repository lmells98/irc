...
SERVER_SRC = $(addprefix $(SERVER_DIR)/, $(addsuffix .cpp, \
	$(addprefix CommandCentre/, \
		CommandCentre	\
		$(addprefix Dispatcher/, Dispatcher )	\
		$(addprefix Commands/,	\
			UserNickname )	\
	)	\
	Server	\
...
SERVER_INCS = -I$(NETWORK_DIR) -I$(SERVER_DIR) -I$(SERVER_DIR)/CommandCentre -IUtilities
# ============================================================================ /
# 			IRC Client
# ============================================================================ /
